...
$(window).load(function(){
  var $post_para = $(".post-para"),
      ...
      $pre_para.removeClass("invisible"); $digm.text("  sav");
   setTimeout(function(){$pre_para.shuffleLetters({ "text": "Welcome" });$digm.shuffleLetters({ "text": "  sav" });$digm.text("  sav");},1000);
   setTimeout(function(){$pre_para.shuffleLetters({ "text": "to" });$digm.shuffleLetters({ "text": "  sav" });$digm.text("  sav");},2000);


   setTimeout(function(){$pre_para.addClass("invisible");$post_para.fadeIn(600); $digm.text("  sav");},3000);
});
